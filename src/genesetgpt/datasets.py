...
def load_example_gene_set():
    """
    Loads a list of B-cell marker genes generated from the widely-used `10X Genomics PBM3k scRNA-seq dataset`_.
    
    Returns
    -------
        A list of HGNC symbols representing the 50 most-significant marker genes by Wilcoxon test for the B-cell cluster. 

    .. _10X Genomics PBM3k scRNA-seq dataset: https://scanpy.scverse.org/en/stable/tutorials/basics/clustering-2017.html
    """
